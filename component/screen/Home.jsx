    ...
    >
      ...
      <View>
        ...
        >
          ...
          <View style={{
            flexDirection: 'column', alignSelf: 'flex-end', alignContent: 'center', flexwrap: 'wrap', flexShrink: 1,
          }}
          >
            <Text style={styles.buttonContentHeader}> Month</Text>
            <Text style={styles.buttonContentText}>
              See what you can start right now by chosing a month and location.
            </Text>
            <View
              style={{
                borderRadius: 15,
        ...
        >
          ...
          <View style={{
            flexDirection: 'column', alignSelf: 'center', alignContent: 'center', flexwrap: 'wrap', flexShrink: 1,
          }}
          >
            <Text style={styles.buttonContentHeader}> Veggie</Text>
            <Text style={styles.buttonContentText}>
              Choose a veggie to see when to sow, harvest and other relevant information.
            </Text>
            <View
              style={{
                borderRadius: 15,
